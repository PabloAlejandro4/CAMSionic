...
const routes = [
    ...
    {
        path: 'almacen',
        loadChildren: () => __webpack_require__.e(/*! import() | componentes-almacen-almacen-module */ "componentes-almacen-almacen-module").then(__webpack_require__.bind(null, /*! ./componentes/almacen/almacen.module */ "./src/app/componentes/almacen/almacen.module.ts")).then(m => m.AlmacenPageModule)
    },
    {
        path: 'administrativo',
        loadChildren: () => __webpack_require__.e(/*! import() | componentes-administrativo-administrativo-module */ "componentes-administrativo-administrativo-module").then(__webpack_require__.bind(null, /*! ./componentes/administrativo/administrativo.module */ "./src/app/componentes/administrativo/administrativo.module.ts")).then(m => m.AdministrativoPageModule)
    },
    {
        path: 'calendario',
        loadChildren: () => __webpack_require__.e(/*! import() | componentes-calendario-calendario-module */ "componentes-calendario-calendario-module").then(__webpack_require__.bind(null, /*! ./componentes/calendario/calendario.module */ "./src/app/componentes/calendario/calendario.module.ts")).then(m => m.CalendarioPageModule)
    },
    {
        path: 'configuracion',
        loadChildren: () => __webpack_require__.e(/*! import() | componentes-configuracion-configuracion-module */ "componentes-configuracion-configuracion-module").then(__webpack_require__.bind(null, /*! ./componentes/configuracion/configuracion.module */ "./src/app/componentes/configuracion/configuracion.module.ts")).then(m => m.ConfiguracionPageModule)
    },
    {
        path: 'perfil',
    ...
    {
        path: 'centrales',
        loadChildren: () => __webpack_require__.e(/*! import() | componentes-centrales-centrales-module */ "componentes-centrales-centrales-module").then(__webpack_require__.bind(null, /*! ./componentes/centrales/centrales.module */ "./src/app/componentes/centrales/centrales.module.ts")).then(m => m.CentralesPageModule)
    },
    {
        path: 'usuarios',
        loadChildren: () => __webpack_require__.e(/*! import() | componentes-usuarios-usuarios-module */ "componentes-usuarios-usuarios-module").then(__webpack_require__.bind(null, /*! ./componentes/usuarios/usuarios.module */ "./src/app/componentes/usuarios/usuarios.module.ts")).then(m => m.UsuariosPageModule)
    },
    {
        path: 'actores',
        loadChildren: () => __webpack_require__.e(/*! import() | componentes-actores-actores-module */ "componentes-actores-actores-module").then(__webpack_require__.bind(null, /*! ./componentes/actores/actores.module */ "./src/app/componentes/actores/actores.module.ts")).then(m => m.ActoresPageModule)
    },
    {
        path: 'archivo',
        loadChildren: () => __webpack_require__.e(/*! import() | componentes-archivo-archivo-module */ "componentes-archivo-archivo-module").then(__webpack_require__.bind(null, /*! ./componentes/archivo/archivo.module */ "./src/app/componentes/archivo/archivo.module.ts")).then(m => m.ArchivoPageModule)
    },
    {
        path: 'tutoriales',
...
module.exports = __webpack_require__(/*! C:\Users\EmmanuelOrtiz\Documents\EstadiasTSU\CAMS\src\main.ts */"./src/main.ts");
